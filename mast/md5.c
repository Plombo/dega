...
/* $Id: md5.c,v 1.8.4.1 2001/01/09 22:49:06 bwelling Exp $ */
 ...
 */
void
Md5Update(Md5_t *ctx, const unsigned char *buf, unsigned int len) {
	uint32_t t;
 ...
 */
void
Md5Final(Md5_t *ctx, unsigned char *digest) {
